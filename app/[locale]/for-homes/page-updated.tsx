      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            ...
            <AnimatedSection animation="fade-in-left" className="order-1 lg:order-2 relative">
              <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-accent-50 rounded-full z-0"></div>
              ...
              <div className="relative h-80 md:h-96 rounded-xl overflow-hidden shadow-xl z-10">
                <div className="absolute inset-0 bg-gradient-to-r from-accent-600 to-primary-600 opacity-20 mix-blend-overlay z-10"></div>
                <ImageWithAnimation 
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 relative">
            <div className="hidden md:block absolute top-8 left-0 w-full h-0.5 bg-gray-100"></div>
            
            <AnimatedSection animation="fade-in-up" delay={100}>
              <div className="p-6 bg-white rounded-xl shadow border border-gray-100 relative pt-10 transform hover:scale-105 transition-transform">                <div className="w-12 h-12 bg-accent-100 rounded-full flex items-center justify-center font-bold text-accent-600 text-xl absolute -top-6 left-6 z-10">
                  1
                </div><h3 className="text-xl font-bold mb-4 text-gray-800">{t('process_step1_title') || 'Initial Consultation'}</h3>
