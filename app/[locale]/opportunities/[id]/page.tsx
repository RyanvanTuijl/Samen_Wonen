...
import { locations, getLocalizedText } from '../../../data/locationsData';
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-8">{getLocalizedText(location.description, locale, location.description)}</p>
                    ...
                    <ul className="grid grid-cols-1 gap-2">
                      {location.amenities?.map((amenity, index) => (
                        <li key={index} className="flex items-center text-gray-700">
                          ...
                          {getLocalizedText(amenity, locale, amenity)}
                        </li>
                      ))}
                    </ul>
                  </div>
