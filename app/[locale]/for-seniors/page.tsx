...
export default async function ForSeniorsPage({ params: { locale } }: { params: { locale: string } }) {
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="my-12 relative h-64 md:h-80 rounded-xl overflow-hidden shadow-lg">
            <Image 
              src="/seniors-companion.jpg" 
              fill
              alt={t('image_alt')} 
          ...
          <h2 className="text-3xl font-bold mb-6">{t('section3_title')}</h2>
          <p className="text-lg text-gray-700 mb-4">{t('section3_p1')}</p>
          <p className="text-lg text-gray-700 mb-8">{t('section3_p2')}</p>
